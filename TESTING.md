...
538 tests in the root suite, 191 in the UI across 23 files, one mount test, and a fixture check. What follows is
...
- **`unit`** — 23 files, 191 tests, jsdom, components in isolation.
