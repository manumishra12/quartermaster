...
413 tests in the root suite, 169 in the UI across 22 files, one mount test, and a fixture check. What follows is
...
flowchart TD
  subgraph root["root suite - node --test"]
    ...
    HO["handoff.test.mjs<br/>14 - delegation that cannot widen"]
