...
416 tests in the root suite, 174 in the UI across 21 files, one mount test, and a fixture check. What follows is
...
cd ui
npm run test:unit    # 174 tests, jsdom
...
- **`unit`** — 21 files, 174 tests, jsdom, components in isolation.
