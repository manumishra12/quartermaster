...
339 tests in the root suite, 139 in the UI across 15 files, one mount test, and a fixture check. What follows is
...
cd ui
npm run test:unit    # 139 tests, jsdom
...
- **`unit`** — 15 files, 139 tests, jsdom, components in isolation.
