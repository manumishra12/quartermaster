...
340 tests in the root suite, 142 in the UI across 16 files, one mount test, and a fixture check. What follows is
...
cd ui
npm run test:unit    # 142 tests, jsdom
...
- **`unit`** — 16 files, 142 tests, jsdom, components in isolation.
